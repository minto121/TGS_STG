...
AbstractScene* GameMain::Update()
{
	...
	//	return this;  // 竊・return 縺励↑縺・〒谺｡繝輔Ξ繝ｼ繝縺ｧ繧ｿ繧､繝槭・繧帝ｲ繧√ｋ
	//}
...
void GameMain::Draw() const
{
	...
	DrawGraph(770, 30, UI_Img[0], TRUE);	//・ｽX・ｽR・ｽA
	DrawGraph(800, 130, UI_Img[1], TRUE);	//・ｽn・ｽC・ｽX・ｽR・ｽA
	DrawGraph(830, 230, UI_Img[2], TRUE);	//・ｽv・ｽ・ｽ・ｽC・ｽ・ｽ・ｽ[・ｽc・ｽ@
	DrawGraph(770, 330, UI_Img[3], TRUE);	//・ｽ^・ｽC・ｽ・ｽ
	DrawGraph(780, 430, UI_Img[4], TRUE);	//・ｽ{・ｽ・ｽ・ｽ・ｽ
