...
{
    if (!isPlayerBullet) {
        return false;  // ÉvÉåÉCÉÑÅ[ÇÃíeÇ≈Ç»Ç¢èÍçáÇÕè’ìÀÇµÇ»Ç¢
    }

    float dx = bulletX - enemy_X;
    float dy = bulletY - enemy_Y;
    float distanceSq = dx * dx + dy * dy;
    return distanceSq <= (radius + 8.0f) * (radius + 8.0f);  // íeÇÃîºåaÇ‡â¡éZÅi8.0fÇÕÉvÉåÉCÉÑÅ[íeÇÃîºåaÅj
}
